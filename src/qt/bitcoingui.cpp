...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/onecoin"), tr("&About Onecoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/onecoin"), tr("&Show / Hide"), this);
