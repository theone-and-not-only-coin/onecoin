...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "OC.lnk";
}
...
{
    return GetAutostartDir() / "oc.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("OCP-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  ocp-qt [" + tr("command-line options") + "]                     " + "\n";
